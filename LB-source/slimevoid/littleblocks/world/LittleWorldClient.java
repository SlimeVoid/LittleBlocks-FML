...
public class LittleWorldClient extends WorldClient implements ILittleWorld {
	...
	public LittleWorldClient(World referenceWorld, NetClientHandler netClientHandler, WorldSettings worldSettings, int dimensionId, int par4, Profiler profiler, ILogAgent iLogAgent) {
		super(netClientHandler, worldSettings, dimensionId, par4, profiler, iLogAgent);
	...
	public void idModified(int lastId, int xCoord, int yCoord, int zCoord,
			int side, int littleX, int littleY, int littleZ, int id, int metadata) {
		this.getLittleWorld().idModified(lastId, xCoord, yCoord, zCoord, side, littleX, littleY, littleZ, id, metadata);
	}

	@Override
	public void metadataModified(int xCoord, int yCoord, int zCoord,
			int side, int littleX, int littleY, int littleZ, int id, int metadata) {
		this.getLittleWorld().metadataModified(xCoord, yCoord, zCoord, side, littleX, littleY, littleZ, id, metadata);
	}
