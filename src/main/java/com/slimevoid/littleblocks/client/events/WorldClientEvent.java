	...
	public void onWorldLoad(Load event) {
		if (event.world instanceof WorldClient
			...
			WorldProvider provider = WorldProvider
					.getProviderForDimension(dimension);

			ConfigurationLib.littleWorldClient = new LittleWorldClient(world,
					world.getSaveHandler(), "LittleWorldClient", provider,
					new WorldSettings(world.getWorldInfo().getSeed(), world
							...
							.getTerrainType()),
					world.difficultySetting.getDifficultyId(), null);
		}
	}
