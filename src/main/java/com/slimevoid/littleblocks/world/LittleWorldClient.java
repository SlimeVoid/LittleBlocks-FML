...
public class LittleWorldClient extends World implements ILittleWorld {
	...
	public LittleWorldClient(World referenceWorld, ISaveHandler saveHandler,
			String worldName, WorldProvider provider,
			WorldSettings worldSettings, int difficultySetting,
			Profiler profiler) {
