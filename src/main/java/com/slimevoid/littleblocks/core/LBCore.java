...
public class LBCore {
	...
	public static void registerItems() {
		ConfigurationLib.littleBlocksWand = new ItemLittleBlocksWand(
				ConfigurationLib.littleBlocksWandID)
	...
	public static void registerBlocks() {
		ConfigurationLib.littleChunk = new BlockLittleChunk(
				ConfigurationLib.littleChunkID, TileEntityLittleChunk.class,
				Material.wood, 2F, true).setBlockName(BlockLib.LITTLECHUNK);
		...
		EntityRegistry.registerModEntity(
				...
				LittleBlocks.instance, 256, 1, false);
	...
	public static void registerPistonOverride() {
		...
		// false);
		Block newPistonSticky = new BlockLBPistonBase(29, true)
				.setBlockName("pistonStickyBase");
		Block newPistonBase = new BlockLBPistonBase(33, false)
	...
	public static void registerDoorOverride() {
		...
		// false);
		Block newDoorWood = new BlockLBDoor(64, Material.wood)
				.setHardness(3.0F).setStepSound(Block.soundTypeWood)
				.setBlockName("doorWood").setBlockTextureName("door_wood");
		Block newDoorIron = new BlockLBDoor(71, Material.iron)
				.setHardness(5.0F).setStepSound(Block.soundTypeMetal)
				.setBlockName("doorIron").setBlockTextureName("door_iron");
